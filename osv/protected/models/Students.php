...
class Students extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('batch_id, nationality_id, student_category_id, country_id, immediate_contact_id, is_sms_enabled, is_active, is_deleted, has_paid_fees, photo_file_size, user_id', 'numerical', 'integerOnly'=>true),
			array('admission_no, admission_date,first_name,last_name,date_of_birth', 'required'),
			array('admission_no, class_roll_no, first_name, middle_name, last_name, gender, blood_group, birth_place, language, religion, address_line1, address_line2, city, state, pin_code, phone1, phone2, email, photo_file_name, photo_content_type, status_description', 'length', 'max'=>255),
	...
	public function getFullname()
        {
                ...
                return '</td><td height="50" >'.CHtml::link($this->first_name, array('/students/students/view', 'id'=>$this->id)).'
                                           </td><td height="50" align="center">'.$this->admission_no.'</td>'.
                                         '</tr>';
