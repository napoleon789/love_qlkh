...
class Employees extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('employee_category_id, employee_position_id, employee_department_id, reporting_manager_id, employee_grade_id, experience_year, experience_month, status, children_count, nationality_id, home_country_id, office_country_id, photo_file_size, is_deleted, user_id', 'numerical', 'integerOnly'=>true),
			...
			array('joining_date, experience_detail, date_of_birth, photo_data, created_at, updated_at', 'safe'),
			array('employee_number, first_name, last_name, gender, date_of_birth', 'required'),
