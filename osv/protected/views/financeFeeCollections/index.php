...
<div>
 <?php echo CHtml::link('Create FinanceFeeCollections', array('#'),array('id'=>'add_finance-fee-collections','class'=>'cbut')) ?>
 ...
 //VIEW
    ...
    $('.fan_view').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=financeFeeCollections/returnView",
...
//UPDATE
    ...
    $('.fan_update').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=financeFeeCollections/returnForm",
                ...
                success: function(data) {
                    $.fancybox(data,
                            {    "transitionIn"    :  "elastic",
                                ...
                                $.fn.yiiGridView.update('finance-fee-collections-grid', {url:'<?php echo Yii::app()->request->baseUrl;?>/index.php?r=financeFeeCollections',data:{"FinanceFeeCollections_page":page}});
                                }//onclosed
                            });//fancybox
                    //  console.log(data);
                } //success
...
// DELETE
    ...
    $('.fan_del').each(function(index) {
        ...
        deletes[id] = function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=financeFeeCollections/ajax_delete",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                    $("#finance-fee-collections-grid").addClass("ajax-sending");
                },
