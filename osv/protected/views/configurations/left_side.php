    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.t('General Settings<span>Set general configurations </span>'),  'url'=>array('/configurations/index'),'linkOptions'=>array('class'=>'menu_1' ), 'itemOptions'=>array('id'=>'menu_1') 
						   ...
						   array('label'=>''.t('User Settings<span>Manage User</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_2','class'=>'menu_2'),  'itemOptions'=>array('id'=>'menu_2'),
						 'items'=>array(
						  array('label'=>t('Create New User<span>New User</span>'), 'url'=>array('/user/create')),
						  array('label'=>t('Manage Users'), 'url'=>array('/user/admin')))
						   ),
					      ...
					      // ),
					array('label'=>''.t('Courses & Batches<span>Add a new Course or Batch</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_2','class'=>'menu_2'),  'itemOptions'=>array('id'=>'menu_2'),
					       'items'=>array(
						array('label'=>t('List Courses & Batches'), 'url'=>array('courses/courses/managecourse')),
						
						array('label'=>t('Create Courses'), 'url'=>array('courses/courses/create'),
