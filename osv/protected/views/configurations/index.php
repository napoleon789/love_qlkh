...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="setbx_con">
    	<div class="setbx" style="width:930px;">
    	<div class="setbx_top">
    	<h1>General Settings</h1>
    	</div>
    	<div class="setbx_bot">
    		<ul>
    			<li><?php echo CHtml::link('School Setup<span>School Name,Logo..</span>', array('/configurations/create'),array('class'=>'icon19')) ?></li>
                <li><?php echo CHtml::link('News &amp; Events<span>Create/View Events</span>', array('/cal'),array('class'=>'icon20')) ?></li>
    ...
    <div class="clear"></div>
    	...
    	<div class="setbx_bot">
   			<ul>
    			<li><a href="#enroll_process" id="enroll_p" class="icon26">Enrollment Process<span>Admins &amp; Class Teachers</span></a></li>
    			...
    			<li>
                <?php echo CHtml::link('Manage Category<span>Admins &amp; Class Teachers</span>', array('students/studentCategory'),array('class'=>'icon34')) ?></li>
            </ul>
    	</div>
    	<div class="clear"></div>
    	</div>
        ...
        <div class="setbx" style="width:930px;">
    	<div class="setbx_top">
    	<h1>Course/Batch Settings</h1>
    	</div>
    	<div class="setbx_bot">
    		<ul>
    			<li><?php echo CHtml::link('Manage Courses<span>Create,Manage &amp; Reorder</span>', array('courses/courses/managecourse'),array('class'=>'icon30')) ?></li>
                ...
                <li><?php echo CHtml::link('Default Subjects<span>Site Wide Default Subjects</span>', array('#'),array('id'=>'add_subjects','class'=>'icon5')) ?></li>
                <!--<a href="#" class="icon5">Default Subjects<span>Admins &amp; Class Teachers</span></a>-->
                <li><?php echo CHtml::link('Subject-Batch Association<span>Associate Cources to Subjects</span>', array('employees/employeesSubjects/create'),array('class'=>'icon6')) ?></li>
                <li><?php echo CHtml::link('Default Weekdays<span>Default School Weekdays</span>', array('courses/weekdays'),array('class'=>'icon13')) ?></li>
    	...
    	<div class="setbx_bot">
    		<ul>
                ...
                <li><?php echo CHtml::link('Subject Association<span>Associate Cources to Subjects</span>', array('employees/employeesSubjects/create'),array('class'=>'icon32')) ?></li>
                <li><?php echo CHtml::link('Manage Categories<span>Employee Categories</span>', array('employees/employeeCategories/admin'),array('class'=>'icon34')) ?></li>
                <li><?php echo CHtml::link('Manage Department<span>Employee Departments</span>', array('employees/employeeDepartments/admin'),array('class'=>'icon33')) ?></li>
                <li><?php echo CHtml::link('Manage Positions<span>Employee Positions</span>', array('employees/employeePositions/admin'),array('class'=>'icon35')) ?></li>
...
<div class="setbx" style="width:930px;">
    	...
    	<div class="setbx_bot">
    		<ul>
                ...
                <li><?php echo CHtml::link('Manage Categories<span>Fee Categories</span>', array('/financeFeeCategories'),array('class'=>'icon34')) ?></li>
    		</ul>
    	</div>
    	<div class="clear"></div>
    	</div>
...
//CREATE 
    ...
    $('#add_subjects ').bind('click', function() {
        $.ajax({
            ...
            data:{"batch_id":3,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                beforeSend : function() {
