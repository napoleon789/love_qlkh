...
<div class="pdtab_Con" style="width:97%">
        ...
        <td valign="top" width="25%"><div class="dashSide">
        	<ul>
            	<li><a href="#" class="ico15">New Assessment</a></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><a href="#" class="ico16">Reports</a></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><a href="#" class="ico3">Schedule</a></li>
                <li><a href="#" class="ico17">Results</a></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><a href="#" class="ico8">Attendance</a></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><a href="#" class="ico18">Resources</a></li>
