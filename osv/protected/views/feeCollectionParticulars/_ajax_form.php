...
<div id="fee-collection-particulars_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New fee Collection Particulars</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update</h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.fee Collection Particulars was not saved.';
    $val_success_message = ($model->isNewRecord) ?
            'fee Collection Particulars was created successfuly.' :
            'fee Collection Particulars  was updated successfuly.';
  ?>
