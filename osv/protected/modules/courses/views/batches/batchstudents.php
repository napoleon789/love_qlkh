...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tbody><tr>
    ...
    <ul>
    <li>
    <?php echo CHtml::link('Add Student', array('/students/students/create'),array('class'=>'addbttn last'));?>
    </li>
    </ul>
    <div class="clear"></div>
    </div>
                    ...
                    <td class="listbx_subhdng">Actions</td>
						...
						$i=0;
                            foreach($posts as $posts_1)
                            {
								...
								<div  id="<?php echo $i; ?>" class="act_but">Actions</div>
								<div class="act_drop" id="<?php echo $i.'x'; ?>">
									<div class="but_bg_outer"></div><div class="but_bg"><div  id="<?php echo $i; ?>" class="act_but_hover">Actions</div></div>
									<ul>
										<li class="add"><?php echo CHtml::link('Add Leave<span>for add leave</span>', array('#'),array('class'=>'addevnt','name' => $posts_1->id)) ?></li>
										<li class="delete"><?php echo CHtml::link('Make Inactive<span>for add leave</span>', array('/students/students/inactive', 'sid'=>$posts_1->id,'id'=>$_REQUEST['id']),array('confirm'=>'Are You Sure , Make Inactive ?')) ?></li>
    ...
    <div class="table_listbx">
     <?php
                    ...
                    <td class="listbx_subhdng">Actions</td>
						...
						$i=0;
                            foreach($posts as $posts_1)
                            {
								...
								<td >
								<div style="position:absolute;">
								<div  id="<?php echo $j; ?>" class="act_but">Actions</div>
								<div class="act_drop" id="<?php echo $j.'x'; ?>">
									<div class="but_bg_outer"></div><div class="but_bg"><div  id="<?php echo $j; ?>" class="act_but_hover">Actions</div></div>
									<ul>
										
										<li class="edit"><?php echo CHtml::link('Make Active<span>for add leave</span>', array('/students/students/active', 'sid'=>$posts_1->id,'id'=>$_REQUEST['id']),array('confirm'=>'Are You Sure , Make Active ?')) ?></li>
										<li class="delete"><a href="#">Delete<span>for add leave</span></a></li>
				...
				{
					echo '<br><div class="notifications nt_red" style="padding-top:10px"><i>No InActive Students In This Batch</i></div>'; 
