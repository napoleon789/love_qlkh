...
<div class="emp_right">
 ...
 <div class="c_subbutCon" align="right" style="width:100%">
    ...
    <ul>
    <li>
    <?php echo CHtml::link('Add Subjects To Batch', array('#'),array('id'=>'add_subjects','class'=>'addbttn')) ?>
    
	</li>
    <li>
    <?php echo CHtml::link('All Subjects', array('/courses/defaultsubjects','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
