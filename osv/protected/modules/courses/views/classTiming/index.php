...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <!--     
    ...
    <div class="c_cubbut" style="width:110px;">
    <ul>
    <li>
    <?php echo CHtml::link('Time Table', array('/courses/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
...
<div class="right" align="right">
           ...
           <?php echo CHtml::link('Create Class Timings', array('#'),array('id'=>'add_class-timings','class'=>'cbut')) ?>
</div>
