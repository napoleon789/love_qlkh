...
<div class="emp_right">
 ...
 <div class="c_subbutCon" align="right" style="width:100%">
    ...
    <li>
    <?php echo CHtml::link('Subjects', array('/courses/subject','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
...
<div class="right" align="right">
            ...
            <?php echo CHtml::link('Add New Subject', array('#'),array('id'=>'add_subject-name','class'=>'cbut')) ?>
