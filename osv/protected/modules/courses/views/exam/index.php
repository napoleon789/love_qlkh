...
<div class="c_subbutCon" align="right" style="width:100%">
    <div class="c_cubbut" style="width:250px;">
    <ul>
    <li>
<?php echo CHtml::link('Create Exam', array('#'),array('id'=>'add_exam-groups','class'=>'addbttn')) ?>
 </li>
 <li>
<?php echo CHtml::link('Grading Levels', array('/courses/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
 </li>
    </ul>
    <div class="clear"></div>
    </div>
