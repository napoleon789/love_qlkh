...
if($mon_num=='12')
{
 ...
 ?>
	...
	<?php 
	echo CHtml::link('<div class="atnd_arow_l"><img src="images/atnd_arrow-l.png" width="7" border="0"  height="13" /></div>', array('index', 'mon'=>date("m",strtotime("2011-".$mon_num."-01 -1 months")),'id'=>$_REQUEST['id'])); 
	 echo $mon.'&nbsp;&nbsp;&nbsp; '.$curr_year; echo CHtml::link('<div class="atnd_arow_r"><img src="images/atnd_arrow.png" width="7" border="0"  height="13" /></div>', array('index', 'mon'=>date("m",strtotime("2011-".$mon_num."-01 +1 months")),'id'=>$_REQUEST['id']));?></div>
<br /><br />
<div class="atnd_Con">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
...
<div class="ea_pdf" style="top:22px; ">
 <?php echo CHtml::link('<img src="images/pdf-but.png" border="0">', array('StudentAttentance/pdf','id'=>$_REQUEST['id']),array('target'=>'_blank')); ?></div>
