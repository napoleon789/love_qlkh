...
<div class="c_subbutCon" align="right" style="width:100%">
    <div class="c_cubbut" style="width:125px;">
    <ul>
    
 
    <li>
    <?php echo CHtml::link('Assessments', array('/courses/exam','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
    </ul>
    <div class="clear"></div>
    </div>
...
<div class="formConInner" style="padding-top:10px;"> 
<h3>Grading Levels</h3>

<div class="right" align="right">
               
            <?php echo CHtml::link('Create Grading Levels', array('#'),array('id'=>'add_grading-levels','class'=>'cbut'));?>
            <?php echo CHtml::link('Set Default Grading Levels', array('gradingLevels/default','id'=>$_REQUEST['id']),array('class'=>'cbut','confirm'=>'Are You Sure? All custom settings will be deleted.'));?>
