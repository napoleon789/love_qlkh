...
<div id="grading-levels_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New GradingLevels</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update GradingLevels <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
...
<?php   $formId='grading-levels-form';
   ...
   ($model->isNewRecord)?CController::createUrl('gradingLevels/ajax_create')
    ...
    <div class="row">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'min_score'); ?>
