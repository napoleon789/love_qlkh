<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <ul style="width:730px;">
        <li> <?php echo CHtml::link('Profile', array('view', 'id'=>$model->id),array('class'=>'active')); ?></li>
 ...
 <tr>
  ...
  <tr >
    <td colspan="4" class="listbx_subhdng">In case of emergencies,<br />
	  ...
	  {
		  echo $posts->first_name.'&nbsp;&nbsp;'.CHtml::link('Edit', array('/students/guardians/update', 'id'=>$posts->id,'std'=>$model->id));
	  }
	   ?></td>
  </tr>
  <tr class="listbxtop_hdng">
