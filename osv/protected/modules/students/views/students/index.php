...
<div class="clear"></div>
  ...
  <div class="pdtab_Con" style="width:97%">
                <div style="font-size:13px; padding:5px 0px"><strong>Recent Admissions</strong></div>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr class="pdtab-h">
	              ...
	              { ?>
                    <tbody>
                    <tr>
                    <td align="center"><?php echo $list_1->admission_date ?>&nbsp;</td>
        ...
        <td valign="top" width="25%"><div class="dashSide">
        	<ul>
            	<li><?php echo CHtml::link('New Admission',array('create'),array('class'=>'ico1')) ?></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <?php /*?><li><a href="#" class="ico2">Import Students</a></li><?php */?>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <?php /*?><li><?php echo CHtml::link('Attendance',array('#'),array('class'=>'ico3')) ?></li><?php */?>
                <li><?php echo CHtml::link('All Students',array('manage'),array('class'=>'ico4')) ?></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><?php echo CHtml::link('Guardians',array('guardians/admin'),array('class'=>'ico5')) ?></li>
                <li class="sptr"><img src="images/line_side.png" width="1" height="130" /></li>
                <li><?php echo CHtml::link('Categories',array('/students/studentCategory'),array('class'=>'ico6')) ?></li>
...
<div class="yellow_bx" style="background-image:none;width:680px;padding-bottom:45px;">
                    ...
                    <div class="y_bx_list" style="width:650px;">
                    	<h1><?php echo CHtml::link('Create New Students',array('create')) ?></h1>
                        <p>Before Creating Students, make sure you created <?php echo CHtml::link('Student Categories',array('/students/studentCategory')) ?> and the <?php echo CHtml::link('Cources &amp; Batches',array('/courses/courses/create')) ?> for enrolling Students.</p>
                    </div>
