...
<div class="captionWrapper">
	<ul>
    	<li><h2  class="cur">1.Student Details</h2><span>Admission Details</span></li>
...
<?php  }
 ...
 ?>
<div class="formCon">
<h2><?php if(Yii::app()->controller->action->id=='create') { ?> <span>Step 1.</span> <?php } ?> Student details</h2>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	echo $form->fileField($model,'photo_data'); ?>
		...
		{
		echo CHtml::link('Remove', array('Students/remove', 'id'=>$model->primaryKey)); 
