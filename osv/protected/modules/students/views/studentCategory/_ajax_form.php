...
<div id="student-categories_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New StudentCategories</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update StudentCategories <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
...
<?php   $formId='student-categories-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentCategory/ajax_create')
    ...
    <div class="row">
        ...
        <span id="success-StudentCategories_name"
