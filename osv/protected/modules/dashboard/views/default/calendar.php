...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div id="othleft-sidebar">
			...
			array('label'=>''.t('Events<span>Your Calendar and Schedules</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_3','class'=>'menu_3'), 'itemOptions'=>array('id'=>'menu_2'),
					       'items'=>array(
						array('label'=>t('Calander'), 'url'=>array('/dashboard/default/calendar'),
								'active'=> ((Yii::app()->controller->module->id=='dashboard') ? true : false)),
								array('label'=>t('Events List'), 'url'=>array('/message/compose'),
								'active'=> ((Yii::app()->controller->module->id=='dashboard') ? true : false)),
								array('label'=>t('Reminders / To-Do'), 'url'=>array('/message/sent/sent'),
								'active'=> ((Yii::app()->controller->module->id=='dashboard') ? true : false)),
					    )),
			//My Account Link	
					array('label'=>''.t('My Account<span>Your Profile, Preferences</span>'), 'url'=>'javascript:void(0);','linkOptions'=>array('id'=>'menu_2','class'=>'menu_2'),  'itemOptions'=>array('id'=>'menu_2'),
					       'items'=>array(
						array('label'=>t('My Profile'), 'url'=>array('/employeeLeaveTypes')),
						array('label'=>t('Settings'), 'url'=>'#',
						...
						array('label'=>t('Examination Report'), 'url'=>'#',
								'active'=> ((Yii::app()->controller->id=='bemenu') && (in_array(Yii::app()->controller->action->id,array('update','view','admin','index'))) ? true : false)),                                                                                    
					    )),
				),
			)); ?>
