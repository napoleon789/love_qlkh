...
<div id="welcome">
    ...
    <?php echo CHtml::beginForm(); ?>
		...
		<div>
            ...
            <input type="password" id="date" name="serial" value="xxxx xxxx xxxx xxxx xxxx" style="height:30px;font-size:16px;font-weight:bold;color:#060;" size="24" maxlength="24" /><br/></p>
            <br/> <p>E-mail Id:<br/>
