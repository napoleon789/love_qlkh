...
<div class="form">
    ...
    <div class="content">
    <fieldset>
    <div class="emphasize">Check if openschool is compatible with your environment</div>
    <ol>
       <li>Web server ... OK</li>
...
<div class="form">
    ...
    <div class="content">
        ...
        <div class="note" style="text-align: center;">By clicking Next, you agree to the terms stated in the openschool License Agreement above.</div>
        <?php endif; ?>
        </fieldset>
    </div>
</div>
