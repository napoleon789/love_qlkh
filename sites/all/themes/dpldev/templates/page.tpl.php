...
<body class="<?php print $body_classes; ?>">
  <div id="page">
    ...
    <?php if (!empty($title) || !empty($inner_page_title)): ?>
      <h1 class="title" id="page-title">
        <?php print $title; ?>
        <?php if (!empty($inner_page_title)): ?>
          <div id="inner-page-title">
            <?php echo $inner_page_title;?>
          </div>
        <?php endif; ?><!-- /#inner-page-title -->
      </h1>
    <?php endif; ?><!-- /.title, /#page-title -->
    <?php if (!empty($tabs)): ?><div class="tabs clearfix"><?php print $tabs; ?></div><?php endif; ?>
    <?php if (!empty($help)): 
    //print $help; 
    endif; ?>
            ...
            <div class="ctop clearfix">
              <div class="cmiddle clearfix">
                <div id="content-content" class="clear-block">
                  <?php if (!empty($content_top)): ?><div id="conent-top"><?php print $content_top; ?></div><?php endif; ?><!-- /content-top -->
                  <?php print $content; ?>
                </div> <!-- /content-content -->
